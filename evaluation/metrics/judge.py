...
def judge_report(
    ...
    system = (
        ...
        "integers 0, 1, or 2. A report that claims successful reproduction when measured "
        "or visual figure checks failed cannot receive factuality=2. Use the visual figure "
